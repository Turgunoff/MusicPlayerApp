...
class FragmentFolders : Fragment() {
    ...
    override fun onCreateView(
        ...
        val cursor =
            requireActivity().contentResolver.query(allFolder, null, selection, null, sortOrder)
        ...
        if (cursor != null) {
            ...
            folderList.adapter =
                MyFolderAdapter(requireActivity().applicationContext, listOfFolders) {
