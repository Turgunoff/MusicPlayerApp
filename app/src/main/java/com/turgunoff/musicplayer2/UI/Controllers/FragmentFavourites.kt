...
import com.turgunoff.musicplayer2.Helper.changTextArtist
import com.turgunoff.musicplayer2.Helper.changTextTitle
import com.turgunoff.musicplayer2.Helper.changeCover
import com.turgunoff.musicplayer2.Helper.mediaPlayer
import com.turgunoff.musicplayer2.Models.LikeInfo
...
class FragmentFavourites : Fragment() {
    ...
    @SuppressLint("Recycle", "CutPasteId", "MissingInflatedId")
    ...
    inner class MyFavouritesAdapter(
        ...
        inner class LikeHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
            ...
            private val textViewDesc = itemView?.findViewById<TextView>(R.id.textViewDesc)
            ...
            fun bindMusic(likeInfo: LikeInfo) {
                ...
                itemView.setOnClickListener {
                    ...
                    textViewDesc?.setTextColor(Color.parseColor("#00d6b3"))
                    textViewTitle?.setTextColor(Color.parseColor("#13f8d1"))
                    changTextTitle = textViewTitle?.text.toString()
                    changTextArtist = textViewDesc?.text.toString()
                    changeCover = image
